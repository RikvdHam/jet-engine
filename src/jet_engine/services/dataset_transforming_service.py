...
from jet_engine.db.models import DatasetView, User, Dataset
from jet_engine.services.dataset_query_service import create_view
...
def transform_dataset(db: Session, dataset_id: str, current_user: User) -> DatasetView:
