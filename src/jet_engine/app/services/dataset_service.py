...
async def process_csv_upload(
    ...
    tmp_file_path = Path(BASE_DIR) / settings.storage_tmp_dir / file_name
    raw_file_path = Path(BASE_DIR) / settings.storage_raw_dir / file_name_parquet
    ...
    # ---------- 6. Search for suggested mapping ----------
